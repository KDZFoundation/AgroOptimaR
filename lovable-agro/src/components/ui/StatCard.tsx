...
export const StatCard: React.FC<StatCardProps> = ({ label, value, unit, icon, trend, trendValue, className }) => (
    <div className={cn('bg-white p-6 rounded-3xl card-shadow border border-border-custom flex items-center gap-5', className)}>
        <div className="w-14 h-14 bg-green-100/50 rounded-2xl flex items-center justify-center text-green-700">{icon}</div>
        <div>
            ...
            {trend && (
                <div className={cn('flex items-center gap-1 text-[10px] font-bold uppercase mt-1 tracking-wider',
